...
namespace Camino.DAL
{
    ...
    {
        public static void AddContentDataAccessServices(this IServiceCollection services, string connectionName)
        {
            ...
            services.AddTransient<IContentDataProvider, ContentDataProvider>();
        }
    }
}
