...
namespace Camino.Service.Business.Users.Contracts
{
    public interface IUserAttributeBusiness
    {
        ...
        IEnumerable<UserAttribute> Create(IEnumerable<UserAttributeResult> userAttributes);
        ...
        Task<IEnumerable<UserAttribute>> CreateOrUpdateAsync(IEnumerable<UserAttributeResult> userAttributes);
