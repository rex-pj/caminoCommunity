$(function () {
    ...
    $('#farmThumbnails').on('click', '.remove-thumbnail', function () {
        $(this).parent('.thumbnail-item').remove();
        rerenderThumbnailIndexes();
    });

    function rerenderThumbnailIndexes() {
        var thumbnailItems = $("#farmThumbnails").find('.thumbnail-item');
    ...
    $('#thumbnailUpload').fileupload({
        ...
        progress: function (e, data) {
            ...
            var farmThumbnails = $("#farmThumbnails");
            var thumbnailItems = farmThumbnails.find('.thumbnail-item');
            ...
            appendedHtml += '</div>';
            farmThumbnails.append(appendedHtml);
        }
    });
