...
namespace Camino.Infrastructure.EntityFrameworkCore.Repositories.Users
{
    public class UserPhotoRepository : IUserPhotoRepository, IScopedDependency
    {
        ...
        public UserPhotoRepository(IValidationStrategyContext validationStrategyContext, IEntityRepository<UserPhoto> userPhotoRepository,
        ...
        public async Task<UserPhotoUpdateRequest> UpdateUserPhotoAsync(UserPhotoUpdateRequest request, long userId)
        {
            ...
            var userInfo = _userInfoRepository.Find(x => x.Id == userId);
            if (userInfo == null)
            {
            ...
            if (userPhoto == null)
            {
                ...
                await _userPhotoRepository.InsertAsync(userPhoto);
            }
            else
            {
