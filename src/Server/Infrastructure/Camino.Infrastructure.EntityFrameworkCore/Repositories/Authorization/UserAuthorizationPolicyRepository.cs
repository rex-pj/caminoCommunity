...
namespace Camino.Infrastructure.EntityFrameworkCore.Repositories.Authorization
{
    public class UserAuthorizationPolicyRepository : IUserAuthorizationPolicyRepository, IScopedDependency
    {
        ...
        public bool Create(long userId, long authorizationPolicyId, long loggedUserId)
        {
            ...
            _userAuthorizationPolicyRepository.Insert(new UserAuthorizationPolicy()
            {
                UserId = userId,
        ...
        public bool Delete(long userId, short authorizationPolicyId)
        {
            ...
            _userAuthorizationPolicyRepository.Delete(x => x.UserId == userId && x.AuthorizationPolicyId == authorizationPolicyId);
            _dbContext.SaveChanges();
            return true;
        }
