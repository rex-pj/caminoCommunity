...
namespace Camino.Infrastructure.EntityFrameworkCore.Repositories.Authorization
{
    public class RoleAuthorizationPolicyRepository : IRoleAuthorizationPolicyRepository, IScopedDependency
    {
        ...
        public RoleAuthorizationPolicyRepository(IRepository<RoleAuthorizationPolicy> roleAuthorizationPolicyRepository,
            IRepository<AuthorizationPolicy> authorizationPolicyRepository, IRepository<Role> userRepository, IAppDbContext dbContext)
        {
        ...
        public bool Create(long roleId, long authorizationPolicyId, long loggedUserId)
        {
            ...
            _roleAuthorizationPolicyRepository.Insert(new RoleAuthorizationPolicy()
            {
                RoleId = roleId,
        ...
        public bool Delete(long roleId, long authorizationPolicyId)
        {
            ...
            var authorizationPolicy = _authorizationPolicyRepository.Find(x => x.Id == authorizationPolicyId);
