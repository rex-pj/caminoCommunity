...
interface ArticleSearchItemProps {
  article?: any;
}

const ArticleSearchItem: React.FC<ArticleSearchItemProps> = (props) => {
  ...
  const loadCreatedInfo = () => {
    ...
    if (creator) {
      const datePeriod = convertDateTimeToPeriod(article.createdDate);
      creator.info = (
        <Fragment>
